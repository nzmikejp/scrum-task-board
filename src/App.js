      ...
      <div className="wrap">
        <header className="header">
          <div className="header-title">
            ...
            <h1><span>Scrum</span> Task Board</h1>
          </div>
          <div className="header-input">
            <div className="hi-btn">
        ...
        <main className="main">
          <div className="container-fluid">
            <div className="row">
              <div className="section col-md-6 col-lg-3 to-do">
              ...
              <div className="section col-md-6 col-lg-3 to-verify">
                <div className="section-title">
                  <h2>to verity</h2>
                </div>
              </div>
              <div className="section col-md-6 col-lg-3 done">
                <div className="section-title">
                  <h2>done</h2>
                </div>
              </div>
